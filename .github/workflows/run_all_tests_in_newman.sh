...
newman run ./Postman_data_driven_tests/Login_negative_tests.postman_collection.json -d ./Postman_data_driven_tests/Login_negative_data.json -e ./Postman_environments/GitHub_Actions.json -r cli,htmlextra